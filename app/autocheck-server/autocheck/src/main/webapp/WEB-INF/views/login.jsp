...
<html lang="en">
  <head>
    ...
    />
    <link rel="shortcut icon" href="/asset/img/logoweb.png" type="image/x-icon" sizes="64x64">

    <link rel="stylesheet" href="/asset/css/stylelogin.css" />
    <link rel="stylesheet" href="/asset/css/styleRoom3d.css" />
  </head>
  <body>
    <div class="container" id="container">
        <div class="form-container sign-in-container">
            <form autocomplete="off" action="login" method="post">
                ...
                <div class="group">      
                    <input id="email" name="username" type="email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"/>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Email</label>
                    <div class="error-message" style="display: none;">Bạn chưa điền đúng email</div>
                  </div>
                  <div class="group">      
